          ...
          <div class="table-responsive">
            ...
            <table class="table align-items-center table-flush">
                ...
                <tbody>
                    ...
                    <?php if( $key1<4 ){ ?>
                    <tr>
                        <td style="text-align: center;"><img src="<?php echo htmlspecialchars( $value1["img"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" width="40" alt="foto do produto <?php echo htmlspecialchars( $value1["nome"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"></td>
