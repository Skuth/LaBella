    ...
    <div class="productInfo">
        <div class="productPictures">
            ...
            <div class="productSlide">
                <img src="<?php echo htmlspecialchars( $produto["img"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
            </div>
        ...
        <div class="productDesc">
            ...
            <!-- <div class="productSizes">
                <?php $counter1=-1;  if( isset($produto["size"]) && ( is_array($produto["size"]) || $produto["size"] instanceof Traversable ) && sizeof($produto["size"]) ) foreach( $produto["size"] as $key1 => $value1 ){ $counter1++; ?>
        ...
        <div class="products">
            ...
            <div class="productBox">
                <a href="/produto/<?php echo name($value1["nome"]); ?>/<?php echo htmlspecialchars( $key1, ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                    ...
                    <div class="boxInfo">
                        <p class="tag"><?php echo htmlspecialchars( $value1["tag"], ENT_COMPAT, 'UTF-8', FALSE ); ?></p>
